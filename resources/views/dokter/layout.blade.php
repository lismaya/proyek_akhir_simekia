...
<html lang="en">
   <head>
      ...
      <script src="{{ URL::to('adminlte-3.0.5/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.js') }}"></script>
            ...
            <div class="sidebar">
               ...
               <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item">
                        <a href="/dokter/antrian" class="nav-link">
                      ...
                      <li class="nav-item">
                        <a href="/dokter/daftar-data-pasien" class="nav-link">
                           <i class="nav-icon fas fa-th"></i>
                           <p>
                              Data Pasien
                              <!-- <span class="right badge badge-danger">New</span> -->
                     ...
                     <li class="nav-item">
                        <a href="/dokter/profile" class="nav-link">
                           <i class="nav-icon fas fa-th"></i>
                           <p>
                              Profile
                              <!-- <span class="right badge badge-danger">New</span> -->
