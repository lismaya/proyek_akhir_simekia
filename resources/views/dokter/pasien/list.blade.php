                  ...
                  <table id="dataTables" class="table table-bordered table-striped">
                     ...
                     <tbody id="table-antrian-body">
                        ...
                        <tr>                          
                           ...
                           <td>{{ $a->alamat }}</td>
                           <td>
                              <a href="#!" onClick="showRiwayatPemeriksaan({{ $a->id }})"><span class="btn btn-success btn-xs btn-block" style="margin-bottom: 5px">Pemeriksaan</span></a>
                              <a href="#!" onClick="showRiwayatImunisasi({{ $a->id }})"><span class="btn btn-warning btn-xs btn-block" style="margin-bottom: 5px">Imunisasi</span></a>
                              <a href="#!" onClick="showRiwayatAntropometri({{ $a->id }})"><span class="btn btn-info btn-xs btn-block">Antropometri</span></a>
                           </td>                           
                        </tr>
                        @endforeach
                     </tbody>
