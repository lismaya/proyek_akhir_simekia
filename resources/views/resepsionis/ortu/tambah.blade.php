        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" action="/resepsionis/ortu-tambah">
                {{ csrf_field() }}
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="" name="nama_ayah" value="{{ old('nama_ayah') }}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="" name="nama_ibu" value="{{ old('nama_ibu') }}">
