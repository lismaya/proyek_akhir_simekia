...
<html lang="en">
   <head>
      ...
      <title>RESEPSIONIS | SIMEKIA</title>
      <!-- Font Awesome Icons -->
   ...
   <body class="hold-transition sidebar-mini">
         ...
         <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                  ...
                  <div class="info">
                     <a href="" class="d-block">{{ strtoupper(Session::get('user_username')) }}</a>
                  </div>
               </div>
               <!-- Sidebar Menu -->
               <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item">
                        <a href="/resepsionis/antrian" class="nav-link">
                     ...
                     <li class="nav-item">
                        <a href="/resepsionis/ortu" class="nav-link">
                           <i class="nav-icon fas fa-th"></i>
                           <p>
                              Data Orang Tua
                              <!-- <span class="right badge badge-danger">New</span> -->
                      ...
                      <li class="nav-item">
                        <a href="/resepsionis/profile" class="nav-link">
                           <i class="nav-icon fas fa-th"></i>
                           <p>
                              Profile
                              <!-- <span class="right badge badge-danger">New</span> -->
      ...
      <!-- Modal -->
      <div class="modal fade" id="antropometriModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Pencatatan Antropometri</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form role="form" method="POST" action="/resepsionis/simpan-antropometri">
                {{ csrf_field() }}
                <input type="hidden" name="pasien_id" id="antropometri_pasien_id" value="">
                <div class="card-body">
                  <div class="form-group">
                    <label>Berat badan</label>
                    <input type="text" class="form-control" placeholder="" name="berat_badan" required>                     
                  </div>
                  <div class="form-group">
                    <label>Tinggi badan</label>
                    <input type="text" class="form-control" placeholder="" name="tinggi_badan" required>                                    
                  </div>
                  <div class="form-group">
                    <label>Lingkar kepala</label>
                    <input type="text" class="form-control" placeholder="" name="lingkar_kepala" required>                    
                  </div>
